...
export default function RoomsCard({room}) {
    return (
        <div className="col-lg-3 m-2 col-md-4 col-12 text-center shadow-sm hover-me p-2">
           <div className="card">
               <div className="card-body">
               <img src={room.img} className="img-fluid" alt="img"/>
                ...
                {room.available?<Link to={`/meetingRooms/${room.id}`} className="btn btn-outline-danger">SELECT</Link>:<button className="btn btn-danger" disabled>Already Booked.</button>}
